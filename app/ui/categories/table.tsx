            ...
            {categories?.map((category) => (
              ...
              >
                <div className="flex w-full items-center justify-between pt-4 gap-3 items-stretch">
                  <div className="rounded-md border w-full text-center rounded content-center" style={{ backgroundColor: category.category_background_color, color: category.category_color }}>
              ...
              {categories?.map((category) => (
                ...
                >
                  <td className="whitespace-nowrap py-3 pl-6 pr-3 w-full">
                    <div className="rounded-md border flex items-center rounded-lg justify-center h-9 lh-0.5" style={{ backgroundColor: category.category_background_color, color: category.category_color }}>
                      <b>{category.category_description}</b>
                    </div>
                  </td>
